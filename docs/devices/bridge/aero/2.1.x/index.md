...
```json
{
    ...
    "globalSettings": {
        ...
        "numSetItems": 32,
        "numSetLists": 8,
        "numStandardMidiInputInterfaces": 0,
        "numUsbInterfaces": 1,
        "setNameLimit": 16,
        "useDisplay": false,
    ...
    "numBanks": 128,
    "bankSettings": {
        "bankLadderMessageLimit": 128,
        "bankMessageLimit": 64,
        "bankNameLimit": 16,
        "doublePressMessageLimit": 16,
        "expBankMessageLimit": 8,
        "holdMessageLimit": 16,
        "holdReleaseMessageLimit": 16,
        "numExpPedals": 4,
        "numFlexiports": 2,
        "numMidiClocks": 1,
        "numMidiTriggerSwitches": 3,
        "numSwitchesPerGroup": 3,
        "numSwitchColours": 1,
        "numSwitchGroups": 8,
        "pressMessageLimit": 16,
        "releaseMessageLimit": 16,
        "switchNameLimit": 8,
        "toggleOffMessageLimit": 64,
        "toggleOnMessageLimit": 64,
        "useBankExpMessages": true,
        "useBankMessages": true,
        "useBankNames": true,
        "useExtendedInterfaceIndexing": false,
        "useMidiTriggerSwitches": true,
        "useSecondaryLeds": false,
        "useSecondarySwitches": false,
...
```json
{
    ...
    "$id": "piratemidi:bridge:v2.1.7:aero",
    "title": "Pirate MIDI Aero Device API (v2.1.7)",
    "type": "object",
    "properties": {
        "deviceSettings": {
            "type": "object",
